    ...
    public static void AddOpenApiExtensions(this IServiceCollection services)
    {
        ...
        services.AddCors(options =>
        {
            options.AddPolicy("CorsPolicy",
                builder =>
                {
                    builder.WithOrigins("https://localhost:7071", "http://localhost:5279")
        ...
        services.AddSwaggerGen(c =>
        {
            ...
            {
                Version = "v1",
                Title = "AI Incident Analysis Auth Service API",
                Description = "An ASP.NET Core Web API for managing AIIncidentAnalysisAuthServiceAPI",
        ...
        services.AddAuthorizationBuilder()
            .AddPolicy("ApiScope", policy =>
            {
                ...
                policy.RequireClaim("scope", "AIIncidentAnalysisService");
            });
    }
}