...
public class IdentityRulesExtensionsTests
{
    private readonly IServiceProvider _serviceProvider;

    public IdentityRulesExtensionsTests()
    {
        ...
        serviceCollection.AddIdentityRulesExtensions();
    ...
    public void Test_ApplicationCookieOptions_AreConfigured()
    {
        ...
        Assert.Equal("/api/v1/auth/Login", options.LoginPath);
        Assert.Equal("/api/v1/auth/Logout", options.LogoutPath);
        Assert.Equal("/api/v1/auth/AccessDenied", options.AccessDeniedPath);
